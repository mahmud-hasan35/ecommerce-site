...
export default function ProductItem({ product, onFavorite }) {
    ...
    return (
        <div onClick={() => setIsPopup(true)} className="border  p-2">
            <img
            ...
            <div  className="flex w-full p-1">
                <div  className="w-full">
                    <h3 onClick={(e) => handleClick(e,id)} className="font-bold mb-1 cursor-pointer">{productName}</h3>
                ...
                <div className="w-[80px] flex flex-col justify-end mb-3 items-center">
                    {
                        !isFavorite ?
                            ...
                            onClick={() => onFavorite(id)}
                                className="w-6 h-6 text-red-600 dark:text-white cursor-pointer"
                                aria-hidden="true"
                                xmlns="http://www.w3.org/2000/svg"
                                width="24"
                                height="24"
                            ...
                            >
                                ...
                                />
                            </svg> : <svg onClick={() => onFavorite(id)}
                            className="w-6 h-6 text-fuchsia-900 dark:text-white cursor-pointer"
            ...
            {isPopup && <Popup onClose={closeHandler}
             product={product} onFavorite={() =>onFavorite(id)} />}
